...
class DialogAdaptorStudent extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView tvTime=(TextView)listViewItem.findViewById(R.id.tv_time);
        ...
        tvDescription.setText("Location : "+alCustom.get(position).getDescripts());
        tvTime.setText("Time : "+alCustom.get(position).getTimes());
